...
import ksolver.uniflocpy.uPVT.PVT_fluids as PVT
import ksolver.uniflocpy.uMultiphaseFlow.hydr_cor_Beggs_Brill as hydr_cor_BB
import ksolver.uniflocpy.uTemperature.temp_cor_Hasan_Kabir as temp_cor_HK
...
class Pipe:
    ...
    def calc_t_grad_cm(self, p_bar, t_c):
        ...
        self.temp_cor.grad_v_msecm = (
            self.fluid_flow.dvdp_msecpam * self.temp_cor.grad_p_pam
        )
