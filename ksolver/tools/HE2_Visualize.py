...
from ksolver.tools import HE2_tools as tools
import pandas as pd
...
class PipelinesPlotter:
    ...
    nodes_settings = {
        well_type: dict(node_color="blue", node_size=10),
    ...
    def __init__(self, input_df):
        ...
        self.df_edges, self.df_nodes = tools.split_result_df_to_pipes_and_nodes(
            input_df
        )
